...
public class SCR_SpatialScriptNumberVariableOut : MonoBehaviour, ISSAcceptsInt, IOutputNode
{
    ...
    [SerializeField] NodeType nodeTypeRequired = NodeType.Number;
    ...
    public void SetUpOutput()
    {
        ...
        if (inputNodeIDToConnectTo > 0)
        {
            ...
            outputDataLocation = targetObject.GetComponent<ISSAcceptsInt>();
