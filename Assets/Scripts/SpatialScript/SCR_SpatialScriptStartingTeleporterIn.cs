...
public class SCR_SpatialScriptStartingTeleporterIn : MonoBehaviour, ISSAcceptsBool, ISSLineTarget, IInputNode
{
    ...
    {
        //hack for when bool no longer attached
        if (targetTag == lineEndTransform)
        {
            incomingVariable = false;
        }
